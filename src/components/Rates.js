...
const Rates = () => {
  return (
    <section className="py-24 bg-[#97b6b8]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2
          className="text-4xl md:text-4xl font-playfair mb-16 text-stone-900"
          style={{ fontWeight: 300 }}
        >
          Rates and Insurance
        </h2>
        <div className="mb-10">
          <p className="text-base font-libre-franklin text-stone-900 mb-8">
            Session Fee - $200
          </p>
          <p className="text-base font-libre-franklin text-stone-900 mb-8">
        ...
        <p
          className="text-base font-libre-franklin text-stone-900 mb-8"
          style={{ fontWeight: 300 }}
        >
        ...
        <p
          className="text-base font-libre-franklin text-stone-900"
          style={{ fontWeight: 300 }}
        >
